...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 8889, 'dbname' => 'BlogVillaOrange', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_c2376667178f3e2427f1e8b9b233c464b9caeed4e5b2c62ed9c2b68990196e20');
    ...
    {
        return $this->services['assetic.twig_extension'] = new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'BlogServingBundle', 1 => 'AsseticBundle', 2 => 'FrameworkBundle', 3 => 'SecurityBundle', 4 => 'TwigBundle', 5 => 'MonologBundle', 6 => 'SwiftmailerBundle', 7 => 'DoctrineBundle', 8 => 'SensioFrameworkExtraBundle', 9 => 'AppBundle', 10 => 'IvoryCKEditorBundle', 11 => 'KnpMenuBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58a5f42297ae80.96267134')), true);
    ...
    {
        return $this->services['twig.extension.debug.stopwatch'] = new \Symfony\Bridge\Twig\Extension\StopwatchExtension($this->get('debug.stopwatch', ContainerInterface::NULL_ON_INVALID_REFERENCE), false);
    }
